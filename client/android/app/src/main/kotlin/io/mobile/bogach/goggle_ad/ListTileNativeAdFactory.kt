...
class ListTileNativeAdFactory(private val context: Context) : NativeAdFactory {
    ...
    override fun createNativeAd(
        ...
        val nativeAdView = layoutInflater.inflate(R.layout.native_ad_banner, null) as UnifiedNativeAdView

        nativeAdView.setNativeAd(nativeAd)

        val attributionViewSmall = nativeAdView.findViewById<TextView>(R.id.tv_list_tile_native_ad_attribution_small)
        val attributionViewLarge = nativeAdView.findViewById<TextView>(R.id.tv_list_tile_native_ad_attribution_large)
